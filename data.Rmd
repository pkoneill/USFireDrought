...
To further confirm, we use plot_missing function from library(redav) to check the missing percentage and patteren. 
```{r}
...
```
We can see that the data set is complete now. 